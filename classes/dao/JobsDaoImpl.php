...
class JobsDaoImpl implements IJobsDao {
    ...
    public function add($conn, Jobs $obj)
    {
        ...
        $sql .= ", hire_types, school_types, hire_part, position, how_old, descriptions, add_descriptions, keeper_name, keeper_contacts";
        ...
        $sql .= ", '".$obj->getHireTypes()."', '".$obj->getSchoolTypes()."', '".$obj->getHirePart()."', '".$obj->getPosition()."', '".$obj->getHowOld()."'";
